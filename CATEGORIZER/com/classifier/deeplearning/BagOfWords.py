...
#        print element
        ...
        output.to_csv('/home/sduprey/My_Data/My_Outgoing_Data/My_Cdiscount_Challenge/'+name +'bagofword_AverageVectors.csv', index=False, quoting=3)
        print 'Wrote /home/sduprey/My_Data/My_Outgoing_Data/My_Cdiscount_Challenge/'+ name +'bagofword_AverageVectors.csv'
