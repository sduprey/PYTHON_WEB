...
from rf_classifier_full_hashed import rf_classifier_full_hashed

class my_rf_classifier_all_together_category:
    ...
    def train_predict_all_labels(self,Xtrain, ytrain,Xtest):
        ...
        rf_clf=rf_classifier_full_hashed(n_estimators=200, n_jobs=16, min_samples_leaf = 10,random_state=1,bootstrap=False,criterion='entropy',min_samples_split=5,verbose=1,nb_categories=self.nb_categories) 
...
#    nb_categories = 5789
#    D=1048576
    rf_all_categories = my_rf_classifier_all_together_category(D=5789, nb_categories=1048576)
    
    my_saving_training_matrix_file = '/home/sduprey/My_Data/My_Cdiscount_Challenge/hashed_training_matrix.bin.npz'
    Xtrain = rf_all_categories.load_sparse_csr(my_saving_training_matrix_file)
    ...
    ytrain = rf_all_categories.load_csv_output_vector(my_saving_training_outputvector_file_path)
...
#        print('Category size : '+str(sum(y_i)))
    ...
    Xtest = rf_all_categories.load_sparse_csr(my_saving_testing_matrix_file)
    ...
    my_rf_predictions = rf_all_categories.train_predict_all_labels(Xtrain, ytrain, Xtest)
    ...
    rf_all_categories.save_model(filename_category_model, my_rf_predictions)
