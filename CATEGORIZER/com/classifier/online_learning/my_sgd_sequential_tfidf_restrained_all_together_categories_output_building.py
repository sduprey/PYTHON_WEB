...
def write_output_prediction_file(filename, testing_id, category_predictions):
    ...
    my_csv_writer.writerow(["Id_Produit","Id_Categorie"])
...
if __name__ == "__main__":
    ...
    filename_category_model = "/home/sduprey/My_Data/My_Cdiscount_Challenge/sgd_sequential_restrained_tfidf_all_together_submission.csv.npz"
    ...
    file_output = "/home/sduprey/My_Data/My_Cdiscount_Challenge/sgd_sequential_whole_tfidf_restrained_data_all_together_submission_most_likely.csv"
