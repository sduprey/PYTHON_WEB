...
#    nb_categories = 5789
#    D=1048576
    xgb_one_stage = my_xgb_classifier_one_stage_prediction(D=1048576, nb_categories=5789)
...
#        print('Category size : '+str(sum(y_i)))
    ...
    print('Training and predicting xgb classifier for all categories')
    my_xgb_one_stage_predictions = xgb_one_stage.train_predict_one_shot(Xtrain, ytrain, Xtest)
    ...
    xgb_one_stage.save_model(filename_category_model, my_xgb_one_stage_predictions)
