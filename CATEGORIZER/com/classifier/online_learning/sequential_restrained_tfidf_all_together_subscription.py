...
if __name__ == "__main__":
    nb_categories = 5789
    my_output_file = "/home/sduprey/My_Data/My_Cdiscount_Challenge/sequential_restrained_tfidf_all_together_final_submission.csv"
    
    my_saved_weights_output_file = "/home/sduprey/My_Data/My_Cdiscount_Challenge/sequential_restrained_tfidf_online_all_together_submission.csv.npz"
    
    online_subscription_writer = submission_sequential_restrained_tfidf_writer_all_together_category(test='/home/sduprey/My_Data/My_Cdiscount_Challenge/whole_tfidf_restrained_data_testing_matrix.bin.npz', D=1048576 , saved_weights_output_file=my_saved_weights_output_file, output_file=my_output_file, nb_categories=nb_categories)
