...
benchmark_features_selection(LinearSVC(), "PRODUCTION_CLEANED_LINEARSVCCLASS")
benchmark_features_selection(PassiveAggressiveClassifier(n_iter=100), "PRODUCTION_CLEANED_PASSIVEAGGRESSIVE")    
benchmark_features_selection(SVC(gamma=2, C=1), "PRODUCTION_CLEANED_SVCRBF")
benchmark_features_selection(SGDClassifier(alpha=.0001, n_iter=100, penalty="l1"), "PRODUCTION_CLEANED_SGDL1")

benchmark_features_selection(SGDClassifier(alpha=.0001, n_iter=100, penalty="l2"), "PRODUCTION_CLEANED_SGDL2")
benchmark_features_selection(SGDClassifier(alpha=.0001, n_iter=100,  penalty="elasticnet"),"PRODUCTION_CLEANED_ELASTICNET")
benchmark_features_selection(BernoulliNB(alpha=.01),'PRODUCTION_CLEANED_BERNOULLINB')
benchmark_features_selection(NearestCentroid(),'PRODUCTION_CLEANED_NEARESTCENTROID')
benchmark_features_selection(KNeighborsClassifier(n_neighbors=10), "PRODUCTION_CLEANED_KNN")
benchmark_features_selection(MultinomialNB(alpha=.01),'PRODUCTION_CLEANED_MULTINOMIALNB')

benchmark_features_selection(DecisionTreeClassifier(), "PRODUCTION_CLEANED_DECISIONTREE") 
benchmark_features_selection(RandomForestClassifier(), "PRODUCTION_CLEANED_RANDOMFOREST")  
benchmark_features_selection(AdaBoostClassifier(), "PRODUCTION_CLEANED_ADABOOSTCLASSIFIER")
