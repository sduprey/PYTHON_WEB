...
y_train, y_test = np.array(data_train_target), np.array(data_test_target)
...
opts.select_chi2=150000
if opts.select_chi2:
    print("Extracting %d best features by a chi-squared test" %
          opts.select_chi2)
    t0 = time()
    ch2 = SelectKBest(f_classif, k=opts.select_chi2)
...
#   kf = KFold(len(y_train), n_folds=2, shuffle=True, random_state=rng)
