...
def benchmark_gradient_boosting(name):
    ...
    param = {'max_depth':2, 'eta':1, 'silent':1,'nthread' : 10, 'objective':'multi:softprob','num_class':5789}
...
if __name__ == '__main__':
    ...
    print "Read %d labeled train reviews end of file \n" % (train["description"].size)
...
# mapping from integer feature name to original token string    
    ...
    benchmark_gradient_boosting('XGBOOST')
